...
#define KNXCHIP_TO_MCU                 GET_GPIO_PORT_DATA(A,8)                     /* getting bit from knx chip. Attention: this pin is fixed to A0, or the driver has error.*/
#define KNXCHIP_TO_MCU_PA8             GET_GPIO_PORT_DATA(A,8)                     /* getting bit from knx chip. Attention: this pin is fixed to A0, or the driver has error.*/
#define KNXCHIP_TO_MCU_PA9             GET_GPIO_PORT_DATA(A,9)                     /* getting bit from knx chip. Attention: this pin is fixed to A0, or the driver has error.*/
