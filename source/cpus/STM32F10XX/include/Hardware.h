...
#define STM32F_CPUID_BASE     (0x1FFFF7E8)
...
#define UART_4_BASE            (APB1PERIPH_BASE + 0x4C00)
#define UART_5_BASE            (APB1PERIPH_BASE + 0x5000)
...
#define ADC_BASE1             (APB2PERIPH_BASE + 0x2400)
#define ADC_BASE2             (APB2PERIPH_BASE + 0x2800)
...
#define UART4               ((USART_TypeDef *) UART_4_BASE)
#define UART5               ((USART_TypeDef *) UART_5_BASE)
...
#define RCC_CR                               (RCC->CR)                    /* Address of clock control register   */
#define RCC_CFGR                             (RCC->CFGR)                  /* Address of clock configure register */
#define RCC_CIR                              (RCC->CIR)                   /* Address of clock interrupt register */
#define RCC_APB2RSTR                         (RCC->APB2RSTR)              /* Address of APB2 reset register      */
#define RCC_APB1RSTR                         (RCC->APB1RSTR)              /* Address of APB1 reset register      */
#define RCC_AHBENR                           (RCC->AHBENR)                /* Address of AHB enable register      */
#define RCC_APB2ENR                          (RCC->APB2ENR)               /* Address of APB2 enable register     */
#define RCC_APB1ENR                          (RCC->APB1ENR)               /* Address of APB1 enable register     */
#define RCC_BDCR                             (RCC->BDCR)                  /* Address of backup control register  */
#define RCC_CSR                              (RCC->CSR)                   /* Address of control/status register  */
...
#define  RCC_CFGR_ADCPRE_MASK                ((uint32_t)0x0000C000)                      /* 0x0000C000                       */
...
#define GPIO_SET_PORT_DATA(x)    (GPIO_BSRR_BS##x)                          /* getting the set data of port-x.0-15   */
#define GPIO_CLR_PORT_DATA(x)    (GPIO_BSRR_BR##x)                          /* getting the reset data of port-x.0-15 */
...
#define GPIO_GET_PORT_MASK(x)    (GPIO_IDR_IDR##x)                          /* getting the mask data of port-x,0-15  */
...
#define  TIM_SR_CC1F                         ((uint16_t)0x0202)
#define  TIM_SR_CC2OF                        ((uint16_t)0x0400)            /*!<Capture/Compare 2 Overcapture Flag */
#define  TIM_SR_CC2F                         ((uint16_t)0x0404)
#define  TIM_SR_CC3OF                        ((uint16_t)0x0800)            /*!<Capture/Compare 3 Overcapture Flag */
#define  TIM_SR_CC3F                         ((uint16_t)0x0808)
